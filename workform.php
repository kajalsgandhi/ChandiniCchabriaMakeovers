...
<div class='title'>
<h1 align='center'>Confirmation Message.</h1>
</div>
<br>
<br><br>
		<?php
			...
			$email=$_POST['t6'];
			$passwrd=$_POST['t7'];
			print "<p>Thank you ".$fn." ".$ln." for applying for the position. <br>We'll get back to you soon.";
			...
			{
				$sql="insert into work values('$fn','$mn','$ln','$addrs',$phno,'$email','$passwrd');";
